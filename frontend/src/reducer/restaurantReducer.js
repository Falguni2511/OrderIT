import { ALL_RESTAURANTS_REQUEST, ALL_RESTAURANTS_SUCCESS, SORT_BY_RATINGS,SORT_BY_REVIEWS,ALL_RESTAURANTS_FAIL,CLEAR_ERROR, TOGGLE_VEG_ONLY } from "../constants/restaurantConstant";
