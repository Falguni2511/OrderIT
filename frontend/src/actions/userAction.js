...
export const register=(userData)=>async(dispatch)=>{
    try{
        ...
        return data.data.user; //useful if calling function need this data
    }
    catch(error){
...
export const logout=()=>async(dispatch)=>{
    try{
        ...
        dispatch({type:CLEAR_CART}); //clears the cart when the user logs out
